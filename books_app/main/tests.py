...
class MainTests(unittest.TestCase):
    ...
    def test_profile_page(self):
        ...
        # Makes a GET request to the /profile/me1 route
        response = self.app.get('/profile/me1', follow_redirects=True)
        self.assertEqual(response.status_code, 200)

        # Verifies that the response shows the appropriate user info
        result_page_text = response.get_data(as_text=True)

        self.assertIn("me1", result_page_text)
